    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Player"))
        {
            ...
            else if (type == pickupType.Note)
            {
                ...
                {
                    noteTitle.text = "Model - TT9 Mech Prototype Manifest";
                    noteBody.text = "Spec One - Energy Shielding:\r\nPowerful Shields Generated by seperate Powercells. Powercells feature their own Shields.\r\n\r\nSpec Two - Crowd Control Containment Capsules:\r\nCCCC, state of the art dispersion of barriers for civilian containment.\r\n\r\nSpec Three - Shield Piercing Armory:\r\nAll weapoons featured on the Model-TT9 Mech can phase through shielding, to engage other advesaries utilizing Energy Shielding.";
                }
                else if (noteNum == 8)
                {
